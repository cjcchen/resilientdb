...
func init() {
	...
	proto.RegisterType((*CustomQueryRequest)(nil), "resdb.CustomQueryRequest")
	proto.RegisterType((*CustomQueryResponse)(nil), "resdb.CustomQueryResponse")
}

func init() { proto.RegisterFile("resdb.proto", fileDescriptor_0a81bd5ef5ef03a2) }
