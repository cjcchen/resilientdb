...
func (x *TransactionRequest) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *TransactionRequest) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *TransactionResponse) GetRet() int32 {
	if x != nil {
		return x.Ret
	}
	return 0
...
var file_transaction_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x72, 0x65, 0x73, 0x64, 0x62, 0x22, 0x62, 0x0a, 0x12, 0x54, 0x72,
	...
	0x75, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x75, 0x69, 0x64, 0x22, 0x27,
	...
	0x28, 0x05, 0x52, 0x03, 0x72, 0x65, 0x74, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x72, 0x65,
...
var file_transaction_proto_goTypes = []interface{}{
	(*TransactionRequest)(nil),  // 0: resdb.TransactionRequest
	(*TransactionResponse)(nil), // 1: resdb.TransactionResponse
}
