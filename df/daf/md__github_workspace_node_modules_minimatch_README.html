...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('df/daf/md__github_workspace_node_modules_minimatch_README.html','../../'); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md2194"></a>
Features</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2196"></a>
Properties</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md2197"></a>
Methods</h2>
<ul>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2199"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2200"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2201"></a>
...
<h2><a class="anchor" id="autotoc_md2211"></a>
nocomment</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md2215"></a>
allowWindowsEscape</h2>
<p>Windows path separator <code>\</code> is by default converted to <code>/</code>, which prohibits the usage of <code>\</code> as a escape character. This flag skips that behavior and allows using the escape character.</p>
<h1><a class="anchor" id="autotoc_md2216"></a>
