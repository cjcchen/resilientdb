...
<title>ResilientDB: changes log</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('d4/d38/md__github_workspace_node_modules_semver_CHANGELOG.html','../../'); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">changes log </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md2686"></a>
6.2.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md2689"></a>
6.1.1</h1>
<ul>
<li>Add options support for semver.coerce()</li>
<li>Handle undefined version passed to Range.test</li>
</ul>
<h1><a class="anchor" id="autotoc_md2690"></a>
6.1.0</h1>
<ul>
<li>Add semver.compareBuild function</li>
<li>Support <code>*</code> in semver.intersects</li>
</ul>
<h1><a class="anchor" id="autotoc_md2691"></a>
6.0</h1>
<ul>
<li><p class="startli">Fix <code>intersects</code> logic.</p>
<p class="startli">This is technically a bug fix, but since it is also a change to behavior that may require users updating their code, it is marked as a major version increment.</p>
</li>
</ul>
<h1><a class="anchor" id="autotoc_md2692"></a>
5.7</h1>
<ul>
<li>Add <code>minVersion</code> method</li>
</ul>
<h1><a class="anchor" id="autotoc_md2693"></a>
5.6</h1>
<ul>
<li>Move boolean <code>loose</code> param to an options object, with backwards-compatibility protection.</li>
<li>Add ability to opt out of special prerelease version handling with the <code>includePrerelease</code> option flag.</li>
</ul>
...
<h1><a class="anchor" id="autotoc_md2695"></a>
5.4</h1>
<ul>
