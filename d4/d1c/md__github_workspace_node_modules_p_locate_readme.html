...
<title>ResilientDB: p-locate &lt;a href=&quot;https://travis-ci.com/github/sindresorhus/p-locate&quot; &gt;&lt;img src=&quot;https://travis-ci.com/sindresorhus/p-locate.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:d3d9a9a6595521f9666a5e94cc830dab83b65699&amp;dn=expat.txt MIT */
$(document).ready(function(){initNavTree('d4/d1c/md__github_workspace_node_modules_p_locate_readme.html','../../'); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div><div class="header">
  <div class="headertitle"><div class="title">p-locate <a href="https://travis-ci.com/github/sindresorhus/p-locate"><img src="https://travis-ci.com/sindresorhus/p-locate.svg?branch=master" alt="Build Status" style="pointer-events: none;" class="inline"/></a> </div></div>
</div><!--header-->
<div class="contents">
<div class="textblock"><blockquote class="doxtable">
<p>&zwj;Get the first fulfilled promise that satisfies the provided testing function </p>
</blockquote>
...
Install</h1>
<div class="fragment"><div class="line">$ npm install p-locate</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md2356"></a>
Usage</h1>
<p>Here we find the first file that exists on disk, in array order.</p>
<div class="fragment"><div class="line">const pathExists = require(&#39;path-exists&#39;);</div>
<div class="line">const pLocate = require(&#39;p-locate&#39;);</div>
<div class="line"> </div>
...
<div class="line">    const foundPath = await pLocate(files, file =&gt; pathExists(file));</div>
<div class="line"> </div>
<div class="line">    console.log(foundPath);</div>
<div class="line">    //=&gt; &#39;rainbow&#39;</div>
<div class="line">})();</div>
</div><!-- fragment --><p>*The above is just an example. Use <a href="https://github.com/sindresorhus/locate-path"><code>locate-path</code></a> if you need this.*</p>
<h1><a class="anchor" id="autotoc_md2357"></a>
API</h1>
<h2><a class="anchor" id="autotoc_md2358"></a>
pLocate(input, tester, options?)</h2>
...
<hr  />
<div align="center"> <b> <a href="https://tidelift.com/subscription/pkg/npm-p-locate?utm_source=npm-p-locate&amp;utm_medium=referral&amp;utm_campaign=readme">Get professional support for this package with a Tidelift subscription</a> </b> <br  />
